...
add_config "CONFIG_KSU_DEBUG=n"
add_config "CONFIG_KSU_THRONE_TRACKER_ALWAYS_THREADED=y"
add_config "CONFIG_KSU_ALLOWLIST_WORKAROUND=n"
add_config "CONFIG_KSU_LSM_SECURITY_HOOKS=y"
...
package_kernel() {
    ...
    local builds_dir="builds/6.1.151"
